...
* Upload brain section image data.
* Track analysis progress.
* Access your results and outputs.

Your workspace is comprised of your user space, tabs pointing to applications which allow you to carry out the QUINT workflow, in order, and access to project management and documentation.
...
* **Analysis Tracking**: Monitor the progress of your analyses.
* **Result Access**: Quickly access your results and outputs, make use of the visualisation tools integrated into the workflow.
...
**Data Upload**
~~~~~~~~~~~~~~~~~~
Once a project is created, you can upload your brain image series to the project, via the ADD/EDIT SERIES button.
