...
QUINT-online combines the use of a series of applications integrated in an online workbench, accessible through `EBRAINS <https://quint-online.apps.ebrains.eu/>`_. 
...
1. **Prepare the image for upload by adding a unique identifier**.
...
6. **Explore the results** using the plotting *Sandbox*.
